...
class AboutPage extends StatelessWidget {
  ...
  Widget _descriptionSection() {
    final text = "This app was made for me to practice some designs in Flutter and have them available for future references. \n\n" +
        "The code for this app is public and you can find it at my personal Github, it contains the code for all the designs listed in this app.\n\n" +
  ...
  _linksSection() {
    final repoLink = "https://github.com/chrisureza/Flutter-Designs";
